...
public class MoversService {
    ...
    public MoversService(String ref, String name, String nameStr, String number, String date, String description, String status) {
        this.ref = ref;
        this.name = name;
    ...
    public static MoversService MoversServiceFromJson(JSONObject task_item) {
        ...
        return new MoversService(ref, name, nameStr, number, date, description, status);
