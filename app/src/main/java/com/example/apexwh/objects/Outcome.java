...
public class Outcome {
    ...
    public Outcome(String date, String number, String receiver, String order, String orderDescription, String orderType, String status,
    ...
    public static Outcome FromJson(JSONObject task_item){
        ...
        return new Outcome(date, number, receiver, order, orderDescription, orderType, status,
