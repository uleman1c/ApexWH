                        ...
                        if (responseItems.length() == 0){
                            ...
                            items.sort(new Comparator() {
                                ...
                                public int compare(Object o, Object t1) {
                                    ...
                                    String l1 = (sortByStrong ? (String.valueOf(pcco1.product.strong) + pcco1.product.weight) : "0") + pcco1.cell.level;
                                    String l2 = (sortByStrong ? (String.valueOf(pcco2.product.strong) + pcco2.product.weight) : "0") + pcco2.cell.level;
