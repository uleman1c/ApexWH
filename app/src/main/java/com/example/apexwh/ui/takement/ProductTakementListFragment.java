...
public class ProductTakementListFragment extends ListFragment<ProductPlacement> {

    public ProductTakementListFragment() {
        ...
        setListUpdater(new ListUpdater() {
            ...
            public void update(ArrayList items, ProgressBar progressBar, DataAdapter adapter, String filter) {
                ...
                RequestToServer.executeRequestUW(getContext(), Request.Method.GET, "getErpSkladProductTakements", "filter=" + filter, new JSONObject(), 1,
                        new RequestToServer.ResponseResultInterface() {
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                JSONArray responseItems = JsonProcs.getJsonArrayFromJsonObject(response, "ErpSkladProductTakements");
